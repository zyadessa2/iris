...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full t px-4 py-2 lg:flex bg-neutral-800/30",
  ...
  return (
    ...
    >
      <Image
        ...
        height={50}
      />
      {/* <span className="font-medium text-black dark:text-white">IRIS</span> */}
    </a>
  );
};
